  ...
  return (
    <div className='m-4'>
      ...
      <h2 className="text-2xl font-bold my-4 text-white">Category List</h2>
        ...
        <button className="bg-yellow-200 text-gray-700 font-medium px-4 py-2 rounded-lg hover:bg-yellow-300">Add Category</button>
        </Link>
      </div>
        ...
        <tbody>
          {
            ...
            allCategory.map(
              (categoryData, categoryIndex) => {
                return(
                  <tr key={categoryIndex} className="border-t text-white hover:bg-gray-600 text-center">
                      ...
                      <td className="py-2 px-4">
                        {
                          ...
                          ?
                          <button onClick={() => statusChange(categoryData._id)} className="border text-white gap-1 px-3 py-1 rounded-2xl flex items-center justify-between mx-auto">
